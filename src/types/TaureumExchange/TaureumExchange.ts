...
export class TaureumExchange extends ethereum.SmartContract {
  static bind(address: Address): TaureumExchange {
    return new TaureumExchange("TaureumExchange", address);
  }
